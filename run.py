...
# 数据加载器
args.data = 'ETTh1'
args.root_path = '/root/iTransformer/data_provider/AIR/'
args.data_path = 'haidian_final.csv'
args.features = 'MS'
args.target = 'PM2.5'
args.freq = 'h'
...
# 预测任务
args.seq_len = 48#seq_len：label_len 2:1
args.label_len =24#
args.pred_len = 12
args.seasonal_patterns = 'seasonaly'

# 模型定义
args.enc_in = 6#输入多少变量
args.dec_in = 6#
args.c_out = 1#输出变量的个数
args.d_model = 128#与batch_size相关
args.n_heads = 12#越多越好，看电脑性能
args.e_layers = 6
args.d_layers = 6#默认参数
args.d_ff = 1024#2的n次方 512 256 1024 2048
args.moving_avg = 15#试试其他的 小一点好。。
args.factor = 12#informer 5/7
args.distil = True
args.dropout = 0.3#
args.embed = 'timeF'
args.activation = 'gelu'#relu
...
args.batch_size = 128#与d_model相关都是2n次方
args.patience = 5
...
args.target_root_path = '/root/iTransformer/data_provider/AIR/'
args.target_data_path = 'haidian_final.csv'

# 检查GPU可用性，并设置相关参数
if args.use_gpu and args.use_multi_gpu:
    args.devices = [int(id_) for id_ in args.devices.split(',')]
    args.gpu = args.devices[0]
    ...
    if args.is_training:
        for ii in range(args.itr):
            ...
            setting = '{}_{}_{}_{}_ft{}_sl{}_ll{}_pl{}_dm{}_nh{}_el{}_dl{}_df{}_fc{}_eb{}_dt{}_{}_{}_{}_{}'.format(
                ...
                args.distil,
                args.des,
                args.class_strategy, ii,args.pyramid,args.use_RevIN)
